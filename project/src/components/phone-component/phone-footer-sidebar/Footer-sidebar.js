...
const Footer = () => {
  return (
    <div>
        <Box sx={{display: 'flex', alignItems: 'center', textAlign: 'center', backgroundColor: '#fff', position: 'relative',top: '432px', height: '50px', borderBottomRightRadius: '15px', borderBottomLeftRadius: '15px', gap: '40px'}}
        >
